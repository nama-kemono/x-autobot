...
# --- 投稿用プロンプト設定 ---
prompts = {
    "satori": """あなたは、SNSで“売れる投稿”を作るプロのコピーライターです。

以下の条件に従って、1投稿あたり200〜280文字の自然な長文ポストを作成してください。  
対象はX（旧Twitter）であり、1ツイートに収まらなくても構いません。  
人間の感情を動かし、最後に行動を促す構成で書いてください。
...
【文体ルール】：  
・本文中には絵文字・ハッシュタグを使わない（※CTAは除く）  
・自然な日本語で、読点と改行を適度に使い読みやすく  
・口調はカジュアル〜誠実の中間  
・1投稿の文字数は200〜280文字で  
